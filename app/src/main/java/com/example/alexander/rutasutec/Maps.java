...
public class Maps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(status == ConnectionResult.SUCCESS)
        {
            ...
            Dialog dialgo = GooglePlayServicesUtil.getErrorDialog(status,(Activity)getApplicationContext(),10);
            dialgo.show();
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        UiSettings uiSettin = mMap.getUiSettings();
        uiSettin.setZoomControlsEnabled(true);

        // Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(13.7005071, -89.2015087);
